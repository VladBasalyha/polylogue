		...
		<div id="IndexPage" class="w-full overflow-auto">
			<div class="mx-auto max-w-[500px] overflow-hidden">
				<div id="Posts" class="px-4 max-w-[600px] mx-auto">
					<div class="mb-8" v-if="isPosts" v-for="post in posts" :key="post">
					...
					<div v-else>
						<client-only>
							...
							<div v-if="!isLoading && posts.values.length == 0" class="mt-20 w-full flex items-center justify-center mx-auto">
								<div class="text-white mx-auto flex flex-col items-center justify-center">
...
<script setup>
	...
	onBeforeMount(async () => {
		try {
			...
			let res = await userStore.getAllPosts();
			console.log(res);
			if (res._rawValue.length !== 0) {
